...
public interface IJoinChannelConverterService
{
    ...
    MyTelegram.Schema.IUpdates ToJoinChannelUpdates(SendOutboxMessageCompletedSagaEvent data, int layer);
}
...
{
    public MyTelegram.Schema.IUpdates ToJoinChannelUpdates(SendOutboxMessageCompletedSagaEvent data, int layer)
    {
    ...
    {
        return ToJoinChannelUpdates(data, data.RequestInfo.Layer);
    }
